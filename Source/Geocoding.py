...
MtrLvl = 5 #-----------no that says how many meter/ft apart you wish to take a sample for the altitude measurement.
...
#-----------Building the kml File---------------------------------------------------------------------
    ...
    for index, item in enumerate(AltList):
        ...
        f.write(str(LngList[index])+','+str(LatList[index])+','+str((AltList[index]+(Alt_min_bkp+AltReductionRange)))+'\n'+str(LngList[index])+','+str(LatList[index])+',0')
